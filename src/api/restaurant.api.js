...
// ==========================================
// --- NEW: PROMO & OFFERS ENDPOINTS ---
// ==========================================

/**
 * Updates the logged-in owner's promo codes and offer settings
 * @param {Object} offerData - Should contain { isOffersEnabled: boolean, offers: Array }
 */
export const updateOffers = async (offerData) => {
